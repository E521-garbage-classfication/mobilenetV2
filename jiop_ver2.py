...
early_stop_phase1 = EarlyStopping(monitor='val_loss', patience=5, restore_best_weights=True)
early_stop_phase2 = EarlyStopping(monitor='val_loss', patience=5, restore_best_weights=True)
reduce_lr  = ReduceLROnPlateau(monitor = 'val_loss', factor = 0.5, patience = 3, min_lr = 1e-6, verbose = 2)
...
history = model.fit(train_ds, validation_data = val_ds, epochs = 50,
                    callbacks = [early_stop_phase1, reduce_lr, checkpoint_phase1], verbose = 2, class_weight = class_weights)
...
history_fine = model.fit(train_ds, validation_data = val_ds, epochs = 10,
                         callbacks = [early_stop_phase2, reduce_lr, checkpoint_phase2], verbose = 2, class_weight = class_weights)
